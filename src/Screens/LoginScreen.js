...
const LoginScreen = ({regValues, loginValues, setLoginValues, setRegValues, errors, setErrors,handleLoginChange, handleLoginSubmit, handleRegChange, handleRegSubmit }) => {
    //is Sign Up Clicked
